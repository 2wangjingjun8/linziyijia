<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"C:\www\linziyijia/application/admin\view\manage\wordReply.html";i:1546919802;s:59:"C:\www\linziyijia\application\admin\view\public\header.html";i:1546932151;s:59:"C:\www\linziyijia\application\admin\view\public\footer.html";i:1546927858;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
			...
			<div id="sidebar-left" class="span2">
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="menuReply"><i class="icon-edit"></i><span class="hidden-tablet"> 菜单回复</span></a></li>
						<li><a href="wordReply"><i class="icon-edit"></i><span class="hidden-tablet"> 关键词回复</span></a></li>
						<li><a href="otherReply"><i class="icon-edit"></i><span class="hidden-tablet"> 其他设置</span></a></li>
					...
					<div class="box-content">
						...
						<div class="step-content">
							<div class="step-pane active" id="step1">
								<form class="form-horizontal" method="post" />
									<fieldset>	
										<div class="control-group warning">
											<label class="control-label" for="">关键词回复</label>
											<div class="controls">
									  			<textarea name="keyword[]" id="" ><?php echo $data[0]; ?></textarea>
									  			<span class="help-inline">输入格式(关键词:回复值；如"aa:123") </span>
											</div>
								  		</div>
										...
										<div class="control-group warning deletetap">
											<label class="control-label" for="">关键词回复</label>
											<div class="controls">
									  			<textarea name="keyword[]" id="" ><?php echo $vo; ?></textarea>
								...
								<div class="control-group warning">
									<button class="addMore">增加关键词回复</button>
									<button class="subOne">删除最后一个</button>
						  		</div>
							</div>
		...
		$(document).ready(function(){
			$(document).on("click",".addMore",function(){
				var html = '';
					...
					html +='					<div class="control-group warning deletetap">';
					html +='						<label class="control-label" for="">关键词回复</label>';
					html +='						<div class="controls">';
					html +='				  			<textarea name="keyword[]" id="" ></textarea>';
					html +='				  			<span class="help-inline">格式-> 关键词:回复值</span>';
					html +='						</div>';
					html +='			  		</div>';
