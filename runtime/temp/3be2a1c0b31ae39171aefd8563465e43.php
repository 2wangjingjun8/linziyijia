<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"C:\www\linziyijia/application/admin\view\manage\otherReply.html";i:1546933424;s:59:"C:\www\linziyijia\application\admin\view\public\header.html";i:1546932151;s:59:"C:\www\linziyijia\application\admin\view\public\footer.html";i:1546927858;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
								...
								<form class="form-horizontal" method="post" />
									<fieldset>	
										<div class="control-group warning">
											<label class="control-label" for="">被关注时回复</label>
											<div class="controls">
									  			<textarea name="BeConcerned" id=""><?php echo $data['BeConcerned']; ?></textarea>
									  			<span class="help-inline"></span>
											</div>
								  		</div>

										<div class="control-group warning">
											<label class="control-label" for="">其他消息回复</label>
											<div class="controls">
									  			<textarea name="OtherMsg" id="" ><?php echo $data['OtherMsg']; ?></textarea>
									  			<span class="help-inline"></span>
											</div>
								  		</div>
										<div class="control-group warning">
											<label class="control-label" for="">卡券ID</label>
											<div class="controls">
									  			<textarea name="CardId" id=""><?php echo $data['CardId']; ?></textarea>
									  			<span class="help-inline"></span>
											</div>
								  		</div>
									</fieldset>
