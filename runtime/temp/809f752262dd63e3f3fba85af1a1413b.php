<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"C:\www\linziyijia/application/admin\view\manage\login.html";i:1546928209;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div class="login-box">
					...
					<form class="form-horizontal" action="" method="post" />
						<fieldset>
							...
							<input class="input-large span12" name="username" id="username" type="text" placeholder="输入账号" />

							<input class="input-large span12" name="password" id="password" type="password" placeholder="输入密码" />
