<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"C:\www\yunxi/application/index\view\index\user.html";i:1529373225;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<blockquote class="layui-elem-quote">会员信息</blockquote> 
  <div class="layui-form-item" style="color:#f1f1f1">
    ...
    <div style="position: absolute;top:100px;right:50px;"><img src="/public/static/img/1679312485.jpg" style="height:100px;width: 100px;"></div>
    ...
    <dl style="position: absolute;top:100px;left:50px;">
      ...
      <dd>生日：<?php echo $user['BirhtDate']; ?></dd>
